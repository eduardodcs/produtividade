...
public class DetalhesTipoServicoDto {

	private Long id;
	private String descricao;
	private Status status;

	public DetalhesTipoServicoDto(TipoServico tipoServico) {
	...
	public static Page<DetalhesTipoServicoDto> converter(Page<TipoServico> tipoServico) {
		return tipoServico.map(DetalhesTipoServicoDto::new);
	}
